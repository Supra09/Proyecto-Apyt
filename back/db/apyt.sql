...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2024 a las 19:44:28
...
INSERT INTO `clientes` (`id_cliente`, `id_servicio`, `contrato_linea`, `nombres`, `apellidos`) VALUES
(1, 2, '123456789', 'orlando pepino', 'juudhsdjfbdf'),
(2, 2, '456789', 'Cristian', 'Rodriguez');
...
(11, 1, '80132104', 'Orlando', 'Parada Suarez', 'orlando.parada', '$2a$07$6Rmcwi3sT6rR97STIwwApOc7SwuZsXpacPuEVvCa7sRHY/6k9g9Dm'),
(12, 2, '123456789', 'Juan', 'Quiroz', 'juan.quiroz', '$2a$07$mWCNiv3NlD1Ec8k9ll3nS.HqSvGq32EfLaNKNlmAzCHdFWCct7AdG'),
(13, 1, '34564666', 'Andres', 'Mahecha', 'andres.mahecha', '$2a$07$aUwKgu26bY..ae6gFHEfCeoVhY43dur8HqBH/xvjjXVNa8vGRqJpa'),
(14, 2, '808080', 'Orlando', 'Parada', 'Orlando', '$2a$07$6b0eFkorcsEuw//24LEi9eMD/d/lCN22JWa5NsjNvLvm3KR97ALEq');
...
--
ALTER TABLE `clientes`
  MODIFY `id_cliente` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `empleados`
  MODIFY `id_empleado` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `procesos`
  MODIFY `id_proceso` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
